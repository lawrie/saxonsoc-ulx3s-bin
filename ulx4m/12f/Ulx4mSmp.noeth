...
class Ulx4mSmpAbstract(cpuCount : Int, includeFpu: Boolean, includeUsbHost : Boolean, includeUsbDevice : Boolean) extends VexRiscvClusterGenerator(cpuCount){
  ...
  //val systemCtrl = new Ulx4mSystemCtrl(0xBFF000)
...
class Ulx4mSystemCtrl(addressOffset : BigInt)
...
case class Ulx4mLinuxUbootPll() extends BlackBox{
...
class Ulx4mSmp(cpuCount : Int, includeFpu: Boolean, includeUsbHost : Boolean, includeUsbDevice : Boolean) extends Component{
  ...
  // ...
  val system = systemCd.outputClockDomain on new Ulx4mSmpAbstract(cpuCount, includeFpu, includeUsbHost, includeUsbDevice){
  ...
  val force_otg = new Area {
    val usb_fpga_otg_id = out(Bool)
    val n_extrst = out(Bool)

    usb_fpga_otg_id := True
    n_extrst := True
  }
}

object Ulx4mSmpAbstract{
  def default(g : Ulx4mSmpAbstract, includeFpu: Boolean = false) = g.rework {
    import g._
...
object Ulx4mSmp {
  ...
  def default(g : Ulx4mSmp, sdramSize : Int, includeFpu: Boolean) = g.rework{
    import g._
    ...
    Ulx4mSmpAbstract.default(system, includeFpu)
  ...
  def main(args: Array[String]): Unit = {
    ...
    val report = SpinalRtlConfig.generateVerilog(InOutWrapper(default(new Ulx4mSmp(cpuCount, includeFpu, includeUsbHost, includeUsbDevice), sdramSize, includeFpu)))
    BspGenerator("radiona/ulx4m/smp", report.toplevel, report.toplevel.system.cores(0).dBus)
  }
}
...
//    simConfig.withFstWave
    ...
    simConfig.compile(new Component {
      ...
      val top = systemCd.outputClockDomain on new Ulx4mSmpAbstract(1, includeFpu = false, includeUsbHost = false, includeUsbDevice = false){
