// Generator : SpinalHDL v1.3.7    git head : 67b26e4cc69d0e1c6f3af1941ce10e8d448f6ad7
// Date      : 07/12/2019, 11:17:24
// Component : Ulx3sLinuxXip85
...
module UartCtrlRx (
  ...
  assign _zz_1_ = 1'b0;
  assign sampler_synchroniser = bufferCC_6__io_dataOut;
...
//UartCtrlTx_1_ remplaced by UartCtrlTx


//UartCtrlRx_1_ remplaced by UartCtrlRx
...
//UartCtrl_1_ remplaced by UartCtrl
...
//StreamFifo_6_ remplaced by StreamFifo_4_


//StreamFifo_7_ remplaced by StreamFifo_5_
...
module Apb3UartCtrl (
  ...
  reg  _zz_3_;
  wire  _zz_4_;
  wire  uartCtrl_2__io_write_ready;
  wire  uartCtrl_2__io_read_valid;
  wire [7:0] uartCtrl_2__io_read_payload;
  wire  uartCtrl_2__io_uart_txd;
  ...
  wire  uartCtrl_2__io_read_queueWithOccupancy_io_push_ready;
  wire  uartCtrl_2__io_read_queueWithOccupancy_io_pop_valid;
  wire [7:0] uartCtrl_2__io_read_queueWithOccupancy_io_pop_payload;
  wire [7:0] uartCtrl_2__io_read_queueWithOccupancy_io_occupancy;
  wire [7:0] uartCtrl_2__io_read_queueWithOccupancy_io_availability;
  wire [0:0] _zz_5_;
  wire [0:0] _zz_6_;
  wire [7:0] _zz_7_;
  ...
  UartCtrl uartCtrl_2_ ( 
    ...
    .io_write_ready(uartCtrl_2__io_write_ready),
    .io_write_payload(bridge_write_streamUnbuffered_queueWithOccupancy_io_pop_payload),
    .io_read_valid(uartCtrl_2__io_read_valid),
    .io_read_payload(uartCtrl_2__io_read_payload),
    .io_uart_txd(uartCtrl_2__io_uart_txd),
  ...
  StreamFifo bridge_write_streamUnbuffered_queueWithOccupancy ( 
    ...
    .io_pop_ready(uartCtrl_2__io_write_ready),
  ...
  StreamFifo uartCtrl_2__io_read_queueWithOccupancy ( 
    .io_push_valid(uartCtrl_2__io_read_valid),
    .io_push_ready(uartCtrl_2__io_read_queueWithOccupancy_io_push_ready),
    .io_push_payload(uartCtrl_2__io_read_payload),
    .io_pop_valid(uartCtrl_2__io_read_queueWithOccupancy_io_pop_valid),
    .io_pop_ready(_zz_3_),
    .io_pop_payload(uartCtrl_2__io_read_queueWithOccupancy_io_pop_payload),
    .io_flush(_zz_4_),
    .io_occupancy(uartCtrl_2__io_read_queueWithOccupancy_io_occupancy),
    .io_availability(uartCtrl_2__io_read_queueWithOccupancy_io_availability),
    .clkout1(clkout1),
    .clockCtrl_systemResetBeforeBuffer(clockCtrl_systemResetBeforeBuffer) 
  );
  `ifndef SYNTHESIS
  ...
  assign io_uart_txd = uartCtrl_2__io_uart_txd;
  assign io_apb_PREADY = 1'b1;
  always @ (*) begin
    io_apb_PRDATA = (32'b00000000000000000000000000000000);
    case(io_apb_PADDR)
      4'b0000 : begin
        io_apb_PRDATA[16 : 16] = (uartCtrl_2__io_read_queueWithOccupancy_io_pop_valid ^ 1'b0);
        io_apb_PRDATA[7 : 0] = uartCtrl_2__io_read_queueWithOccupancy_io_pop_payload;
      end
      4'b0100 : begin
        io_apb_PRDATA[23 : 16] = _zz_7_;
        io_apb_PRDATA[31 : 24] = uartCtrl_2__io_read_queueWithOccupancy_io_occupancy;
  ...
  assign bridge_interruptCtrl_readInt = (bridge_interruptCtrl_readIntEnable && uartCtrl_2__io_read_queueWithOccupancy_io_pop_valid);
...
module Apb3Gpio2 (
      ...
      input   clkout1,
      input   clockCtrl_systemResetBeforeBuffer);
  wire [23:0] bufferCC_6__io_dataOut;
  wire [0:0] _zz_65_;
  wire [0:0] _zz_66_;
  wire [0:0] _zz_67_;
  wire [0:0] _zz_68_;
  ...
  assign mapper_doWrite = (((io_bus_PSEL[0] && io_bus_PENABLE) && io_bus_PREADY) && io_bus_PWRITE);
  assign mapper_doRead = (((io_bus_PSEL[0] && io_bus_PENABLE) && io_bus_PREADY) && (! io_bus_PWRITE));
  assign syncronized = bufferCC_6__io_dataOut;
  always @ (*) begin
...
//Apb3UartCtrl_1_ remplaced by Apb3UartCtrl
...
module VexRiscv (
  ...
  assign _zz_281_ = _zz_84_[28 : 28];
  assign _zz_282_ = _zz_84_[5 : 5];
  assign _zz_283_ = _zz_84_[3 : 3];
  assign _zz_284_ = ($signed(_zz_286_) >>> execute_FullBarrelShifterPlugin_amplitude);
  assign _zz_285_ = _zz_284_[31 : 0];
  assign _zz_286_ = {((execute_SHIFT_CTRL == `ShiftCtrlEnum_defaultEncoding_SRA_1) && execute_FullBarrelShifterPlugin_reversed[31]),execute_FullBarrelShifterPlugin_reversed};
  assign _zz_287_ = _zz_84_[20 : 20];
  assign _zz_288_ = _zz_84_[35 : 35];
  assign _zz_289_ = _zz_84_[6 : 6];
  assign _zz_290_ = _zz_84_[1 : 1];
  assign _zz_291_ = _zz_84_[10 : 10];
  assign _zz_292_ = _zz_84_[26 : 26];
  assign _zz_293_ = (decode_PC >>> 1);
  assign _zz_294_ = (decode_PC >>> 1);
  assign _zz_295_ = (decode_PC >>> 1);
  assign _zz_296_ = (decode_PC >>> 1);
  assign _zz_297_ = _zz_84_[32 : 32];
  assign _zz_298_ = _zz_84_[27 : 27];
  assign _zz_299_ = _zz_84_[4 : 4];
  assign _zz_300_ = _zz_84_[21 : 21];
  assign _zz_301_ = _zz_84_[2 : 2];
  assign _zz_302_ = _zz_84_[23 : 23];
  assign _zz_303_ = _zz_84_[0 : 0];
  assign _zz_304_ = _zz_84_[31 : 31];
  assign _zz_305_ = _zz_84_[22 : 22];
  assign _zz_306_ = _zz_84_[15 : 15];
  assign _zz_307_ = _zz_84_[30 : 30];
  ...
  assign _zz_454_ = (32'b00000010000000000100000001100100);
  assign _zz_455_ = (decode_INSTRUCTION & (32'b00000000000000000001000000000000));
  assign _zz_456_ = (32'b00000000000000000001000000000000);
  assign _zz_457_ = ((decode_INSTRUCTION & (32'b00000000000000000011000000000000)) == (32'b00000000000000000010000000000000));
  assign _zz_458_ = {(_zz_463_ == _zz_464_),{_zz_465_,{_zz_466_,_zz_467_}}};
  assign _zz_459_ = (5'b00000);
  assign _zz_460_ = ((_zz_468_ == _zz_469_) != (1'b0));
  assign _zz_461_ = (_zz_470_ != (1'b0));
  assign _zz_462_ = {(_zz_471_ != _zz_472_),{_zz_473_,{_zz_474_,_zz_475_}}};
  ...
  assign _zz_466_ = ((decode_INSTRUCTION & _zz_476_) == (32'b00000000000000000000000000010000));
  assign _zz_467_ = {_zz_85_,(_zz_477_ == _zz_478_)};
  assign _zz_468_ = (decode_INSTRUCTION & (32'b00000000000000000000000001100100));
  assign _zz_469_ = (32'b00000000000000000000000000100100);
  assign _zz_470_ = ((decode_INSTRUCTION & (32'b00000000000000000101000001001000)) == (32'b00000000000000000001000000001000));
  assign _zz_471_ = {(_zz_479_ == _zz_480_),{_zz_481_,{_zz_482_,_zz_483_}}};
  assign _zz_472_ = (6'b000000);
  assign _zz_473_ = ((_zz_484_ == _zz_485_) != (1'b0));
  assign _zz_474_ = (_zz_86_ != (1'b0));
  assign _zz_475_ = {(_zz_486_ != _zz_487_),{_zz_488_,{_zz_489_,_zz_490_}}};
  assign _zz_476_ = (32'b00000000000000000000000000110000);
  assign _zz_477_ = (decode_INSTRUCTION & (32'b00000010000000000000000000101000));
  assign _zz_478_ = (32'b00000000000000000000000000100000);
  assign _zz_479_ = (decode_INSTRUCTION & (32'b00000000000000000010000001000000));
  assign _zz_480_ = (32'b00000000000000000010000001000000);
  assign _zz_481_ = ((decode_INSTRUCTION & (32'b00000000000000000001000001000000)) == (32'b00000000000000000001000001000000));
  assign _zz_482_ = ((decode_INSTRUCTION & _zz_491_) == (32'b00000000000000000000000001000000));
  assign _zz_483_ = {(_zz_492_ == _zz_493_),{_zz_494_,_zz_495_}};
  assign _zz_484_ = (decode_INSTRUCTION & (32'b00000000000000000100000001001000));
  assign _zz_485_ = (32'b00000000000000000100000000001000);
  assign _zz_486_ = ((decode_INSTRUCTION & _zz_496_) == (32'b00010000000000000000000000001000));
  assign _zz_487_ = (1'b0);
  assign _zz_488_ = ({_zz_90_,_zz_497_} != (2'b00));
  assign _zz_489_ = ({_zz_498_,_zz_499_} != (2'b00));
  assign _zz_490_ = {(_zz_500_ != _zz_501_),{_zz_502_,{_zz_503_,_zz_504_}}};
  assign _zz_491_ = (32'b00000000000000000000000001010000);
  assign _zz_492_ = (decode_INSTRUCTION & (32'b00000010000100000000000001000000));
  assign _zz_493_ = (32'b00000000000000000000000001000000);
  assign _zz_494_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000111000)) == (32'b00000000000000000000000000000000));
  assign _zz_495_ = ((decode_INSTRUCTION & (32'b00011000000000000010000000001000)) == (32'b00010000000000000010000000001000));
  assign _zz_496_ = (32'b00010000000000000000000000001000);
  assign _zz_497_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001110000)) == (32'b00000000000000000000000000100000));
  assign _zz_498_ = _zz_90_;
  assign _zz_499_ = ((decode_INSTRUCTION & _zz_505_) == (32'b00000000000000000000000000000000));
  assign _zz_500_ = {(_zz_506_ == _zz_507_),{_zz_508_,{_zz_509_,_zz_510_}}};
  assign _zz_501_ = (5'b00000);
  assign _zz_502_ = ({_zz_87_,{_zz_511_,_zz_512_}} != (7'b0000000));
  assign _zz_503_ = (_zz_513_ != (1'b0));
  assign _zz_504_ = {(_zz_514_ != _zz_515_),{_zz_516_,{_zz_517_,_zz_518_}}};
  assign _zz_505_ = (32'b00000000000000000000000000100000);
  assign _zz_506_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_507_ = (32'b00000000000000000000000000000000);
  assign _zz_508_ = ((decode_INSTRUCTION & _zz_519_) == (32'b00000000000000000000000000000000));
  assign _zz_509_ = (_zz_520_ == _zz_521_);
  assign _zz_510_ = {_zz_522_,_zz_88_};
  assign _zz_511_ = (_zz_523_ == _zz_524_);
  assign _zz_512_ = {_zz_525_,{_zz_526_,_zz_527_}};
  assign _zz_513_ = ((decode_INSTRUCTION & _zz_528_) == (32'b00000000000100000000000001010000));
  assign _zz_514_ = (_zz_529_ == _zz_530_);
  assign _zz_515_ = (1'b0);
  assign _zz_516_ = (_zz_531_ != (1'b0));
  assign _zz_517_ = (_zz_532_ != _zz_533_);
  assign _zz_518_ = {_zz_534_,{_zz_535_,_zz_536_}};
  assign _zz_519_ = (32'b00000000000000000000000000011000);
  assign _zz_520_ = (decode_INSTRUCTION & (32'b00000000000000000110000000000100));
  assign _zz_521_ = (32'b00000000000000000010000000000000);
  assign _zz_522_ = ((decode_INSTRUCTION & _zz_537_) == (32'b00000000000000000001000000000000));
  ...
  assign _zz_525_ = ((decode_INSTRUCTION & _zz_538_) == (32'b00000000000000000010000000010000));
  assign _zz_526_ = (_zz_539_ == _zz_540_);
  assign _zz_527_ = {_zz_541_,{_zz_542_,_zz_543_}};
  assign _zz_528_ = (32'b00010000000100000011000001010000);
  assign _zz_529_ = (decode_INSTRUCTION & (32'b00010000000000000000000000001000));
  assign _zz_530_ = (32'b00000000000000000000000000001000);
  assign _zz_531_ = ((decode_INSTRUCTION & _zz_544_) == (32'b00000000000000000100000000010000));
  assign _zz_532_ = (_zz_545_ == _zz_546_);
  assign _zz_533_ = (1'b0);
  assign _zz_534_ = ({_zz_547_,_zz_548_} != (3'b000));
  assign _zz_535_ = (_zz_549_ != _zz_550_);
  assign _zz_536_ = {_zz_551_,{_zz_552_,_zz_553_}};
  assign _zz_537_ = (32'b00000000000000000101000000000100);
  assign _zz_538_ = (32'b00000000000000000010000000010000);
  assign _zz_539_ = (decode_INSTRUCTION & (32'b00000000000000000010000000001000));
  assign _zz_540_ = (32'b00000000000000000010000000001000);
  assign _zz_541_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001010000)) == (32'b00000000000000000000000000010000));
  assign _zz_542_ = _zz_85_;
  assign _zz_543_ = ((decode_INSTRUCTION & _zz_554_) == (32'b00000000000000000000000000000000));
  assign _zz_544_ = (32'b00000000000000000100000000010100);
  assign _zz_545_ = (decode_INSTRUCTION & (32'b00000000000000000110000000010100));
  assign _zz_546_ = (32'b00000000000000000010000000010000);
  assign _zz_547_ = _zz_87_;
  assign _zz_548_ = {_zz_89_,(_zz_555_ == _zz_556_)};
  assign _zz_549_ = {_zz_89_,(_zz_557_ == _zz_558_)};
  assign _zz_550_ = (2'b00);
  assign _zz_551_ = ({_zz_88_,_zz_559_} != (2'b00));
  assign _zz_552_ = ({_zz_560_,_zz_561_} != (2'b00));
  assign _zz_553_ = {(_zz_562_ != _zz_563_),{_zz_564_,{_zz_565_,_zz_566_}}};
  assign _zz_554_ = (32'b00000000000000000000000000101000);
  assign _zz_555_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010100));
  assign _zz_556_ = (32'b00000000000000000000000000000100);
  assign _zz_557_ = (decode_INSTRUCTION & (32'b00000000000000000000000001001100));
  assign _zz_558_ = (32'b00000000000000000000000000000100);
  assign _zz_559_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001011000)) == (32'b00000000000000000000000000000000));
  assign _zz_560_ = _zz_87_;
  assign _zz_561_ = ((decode_INSTRUCTION & _zz_567_) == (32'b00000000000000000000000000000100));
  assign _zz_562_ = ((decode_INSTRUCTION & _zz_568_) == (32'b00000000000000000000000001000000));
  assign _zz_563_ = (1'b0);
  assign _zz_564_ = ({_zz_569_,_zz_570_} != (2'b00));
  assign _zz_565_ = ({_zz_571_,_zz_572_} != (3'b000));
  assign _zz_566_ = {(_zz_573_ != _zz_574_),{_zz_575_,{_zz_576_,_zz_577_}}};
  assign _zz_567_ = (32'b00000000000000000000000000011100);
  assign _zz_568_ = (32'b00000000000000000000000001011000);
  assign _zz_569_ = ((decode_INSTRUCTION & (32'b00000000000000000111000000110100)) == (32'b00000000000000000101000000010000));
  assign _zz_570_ = ((decode_INSTRUCTION & (32'b00000010000000000111000001100100)) == (32'b00000000000000000101000000100000));
  assign _zz_571_ = ((decode_INSTRUCTION & _zz_578_) == (32'b01000000000000000001000000010000));
  assign _zz_572_ = {(_zz_579_ == _zz_580_),(_zz_581_ == _zz_582_)};
  assign _zz_573_ = {(_zz_583_ == _zz_584_),(_zz_585_ == _zz_586_)};
  assign _zz_574_ = (2'b00);
  assign _zz_575_ = ((_zz_587_ == _zz_588_) != (1'b0));
  assign _zz_576_ = ({_zz_589_,_zz_590_} != (2'b00));
  assign _zz_577_ = {(_zz_591_ != _zz_592_),{_zz_593_,{_zz_594_,_zz_595_}}};
  assign _zz_578_ = (32'b01000000000000000011000001010100);
  assign _zz_579_ = (decode_INSTRUCTION & (32'b00000000000000000111000000110100));
  assign _zz_580_ = (32'b00000000000000000001000000010000);
  assign _zz_581_ = (decode_INSTRUCTION & (32'b00000010000000000111000001010100));
  assign _zz_582_ = (32'b00000000000000000001000000010000);
  assign _zz_583_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010000));
  assign _zz_584_ = (32'b00000000000000000010000000000000);
  assign _zz_585_ = (decode_INSTRUCTION & (32'b00000000000000000101000000000000));
  assign _zz_586_ = (32'b00000000000000000001000000000000);
  ...
  assign _zz_589_ = ((decode_INSTRUCTION & _zz_596_) == (32'b00000000000000000000000001010000));
  assign _zz_590_ = ((decode_INSTRUCTION & _zz_597_) == (32'b00010000000000000000000001010000));
  assign _zz_591_ = ((decode_INSTRUCTION & _zz_598_) == (32'b00000000000000000000000001010000));
  assign _zz_592_ = (1'b0);
  assign _zz_593_ = ({_zz_599_,_zz_600_} != (2'b00));
  assign _zz_594_ = (_zz_86_ != (1'b0));
  assign _zz_595_ = {(_zz_601_ != _zz_602_),{_zz_603_,{_zz_604_,_zz_605_}}};
  assign _zz_596_ = (32'b00010000000100000011000001010000);
  assign _zz_597_ = (32'b00010010001000000011000001010000);
  assign _zz_598_ = (32'b00000010000100000011000001010000);
  assign _zz_599_ = ((decode_INSTRUCTION & (32'b00000000000000000001000001010000)) == (32'b00000000000000000001000001010000));
  assign _zz_600_ = ((decode_INSTRUCTION & (32'b00000000000000000010000001010000)) == (32'b00000000000000000010000001010000));
  assign _zz_601_ = ((decode_INSTRUCTION & (32'b00000010000000000100000001110100)) == (32'b00000010000000000000000000110000));
  assign _zz_602_ = (1'b0);
  assign _zz_603_ = ({(_zz_606_ == _zz_607_),{_zz_608_,_zz_609_}} != (3'b000));
  assign _zz_604_ = ({_zz_610_,{_zz_611_,_zz_612_}} != (4'b0000));
  assign _zz_605_ = {({_zz_613_,_zz_614_} != (5'b00000)),({_zz_615_,_zz_616_} != (3'b000))};
  assign _zz_606_ = (decode_INSTRUCTION & (32'b00001000000000000000000000100000));
  assign _zz_607_ = (32'b00001000000000000000000000100000);
  assign _zz_608_ = ((decode_INSTRUCTION & (32'b00010000000000000000000000100000)) == (32'b00000000000000000000000000100000));
  assign _zz_609_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000101000)) == (32'b00000000000000000000000000100000));
  assign _zz_610_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000110100)) == (32'b00000000000000000000000000100000));
  assign _zz_611_ = ((decode_INSTRUCTION & _zz_617_) == (32'b00000000000000000000000000100000));
  assign _zz_612_ = {(_zz_618_ == _zz_619_),(_zz_620_ == _zz_621_)};
  assign _zz_613_ = _zz_85_;
  assign _zz_614_ = {(_zz_622_ == _zz_623_),{_zz_624_,{_zz_625_,_zz_626_}}};
  assign _zz_615_ = ((decode_INSTRUCTION & _zz_627_) == (32'b00000000000000000000000001000000));
  assign _zz_616_ = {(_zz_628_ == _zz_629_),(_zz_630_ == _zz_631_)};
  assign _zz_617_ = (32'b00000000000000000000000001100100);
  assign _zz_618_ = (decode_INSTRUCTION & (32'b00001000000000000000000001110000));
  assign _zz_619_ = (32'b00001000000000000000000000100000);
  assign _zz_620_ = (decode_INSTRUCTION & (32'b00010000000000000000000001110000));
  assign _zz_621_ = (32'b00000000000000000000000000100000);
  assign _zz_622_ = (decode_INSTRUCTION & (32'b00000000000000000010000000110000));
  assign _zz_623_ = (32'b00000000000000000010000000010000);
  assign _zz_624_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000110000)) == (32'b00000000000000000000000000010000));
  assign _zz_625_ = ((decode_INSTRUCTION & (32'b00000010000000000011000000100000)) == (32'b00000000000000000000000000100000));
  assign _zz_626_ = ((decode_INSTRUCTION & (32'b00000010000000000010000001101000)) == (32'b00000000000000000010000000100000));
  ...
  assign _zz_633_ = execute_INSTRUCTION[31];
  assign _zz_634_ = execute_INSTRUCTION[7];
  initial begin
    $readmemb("Ulx3sLinuxXip85.v_toplevel_system_cpu_cpu_RegFilePlugin_regFile.bin",RegFilePlugin_regFile);
  end
  always @ (posedge clkout1) begin
    if(_zz_38_) begin
  ...
  always @(*) begin
    case(_zz_91_)
      ...
      `EnvCtrlEnum_defaultEncoding_XRET : _zz_91__string = "XRET ";
      `EnvCtrlEnum_defaultEncoding_WFI : _zz_91__string = "WFI  ";
      `EnvCtrlEnum_defaultEncoding_ECALL : _zz_91__string = "ECALL";
  ...
  always @(*) begin
    case(_zz_94_)
      ...
      `Src1CtrlEnum_defaultEncoding_IMU : _zz_94__string = "IMU         ";
      `Src1CtrlEnum_defaultEncoding_PC_INCREMENT : _zz_94__string = "PC_INCREMENT";
      `Src1CtrlEnum_defaultEncoding_URS1 : _zz_94__string = "URS1        ";
  ...
  assign decode_IS_SFENCE_VMA = _zz_271_[0];
  ...
  assign memory_MUL_LOW = ($signed(_zz_272_) + $signed(_zz_280_));
  assign memory_PC = execute_to_memory_PC;
  assign decode_MEMORY_MANAGMENT = _zz_281_[0];
  assign decode_SRC2 = _zz_105_;
  assign decode_IS_RS1_SIGNED = _zz_282_[0];
  assign memory_MEMORY_WR = execute_to_memory_MEMORY_WR;
  assign decode_MEMORY_WR = _zz_283_[0];
  assign execute_SHIFT_RIGHT = _zz_285_;
  assign _zz_7_ = _zz_8_;
  assign decode_SHIFT_CTRL = _zz_9_;
  assign _zz_10_ = _zz_11_;
  assign decode_MEMORY_AMO = _zz_287_[0];
  assign decode_IS_DIV = _zz_288_[0];
  assign decode_SRC2_FORCE_ZERO = (decode_SRC_ADD_ZERO && (! decode_SRC_USE_SUB_LESS));
  assign decode_IS_CSR = _zz_289_[0];
  assign decode_BYPASSABLE_EXECUTE_STAGE = _zz_290_[0];
  assign decode_SRC_LESS_UNSIGNED = _zz_291_[0];
  ...
  assign decode_MEMORY_LRSC = _zz_292_[0];
  ...
  assign decode_DO_EBREAK = ((! DebugPlugin_haltIt) && (decode_IS_EBREAK || ((((1'b0 || (DebugPlugin_hardwareBreakpoints_0_valid && (DebugPlugin_hardwareBreakpoints_0_pc == _zz_293_))) || (DebugPlugin_hardwareBreakpoints_1_valid && (DebugPlugin_hardwareBreakpoints_1_pc == _zz_294_))) || (DebugPlugin_hardwareBreakpoints_2_valid && (DebugPlugin_hardwareBreakpoints_2_pc == _zz_295_))) || (DebugPlugin_hardwareBreakpoints_3_valid && (DebugPlugin_hardwareBreakpoints_3_pc == _zz_296_)))));
  assign execute_BYPASSABLE_MEMORY_STAGE = decode_to_execute_BYPASSABLE_MEMORY_STAGE;
  assign decode_BYPASSABLE_MEMORY_STAGE = _zz_297_[0];
  assign memory_MUL_HH = execute_to_memory_MUL_HH;
  assign execute_MUL_HH = ($signed(execute_MulPlugin_aHigh) * $signed(execute_MulPlugin_bHigh));
  assign decode_SRC1 = _zz_100_;
  assign decode_PREDICTION_HAD_BRANCHED2 = IBusCachedPlugin_decodePrediction_cmd_hadBranch;
  assign decode_IS_RS2_SIGNED = _zz_298_[0];
  assign _zz_19_ = _zz_20_;
  assign memory_IS_MUL = execute_to_memory_IS_MUL;
  assign execute_IS_MUL = decode_to_execute_IS_MUL;
  assign decode_IS_MUL = _zz_299_[0];
  ...
  assign _zz_85_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000001100)) == (32'b00000000000000000000000000000100));
  assign _zz_86_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000000000)) == (32'b00000000000000000000000000000000));
  assign _zz_87_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001001000)) == (32'b00000000000000000000000001001000));
  assign _zz_88_ = ((decode_INSTRUCTION & (32'b00000000000000000010000001010000)) == (32'b00000000000000000010000000000000));
  ...
  assign _zz_84_ = {(((decode_INSTRUCTION & _zz_454_) == (32'b00000010000000000100000000100000)) != (1'b0)),{((_zz_455_ == _zz_456_) != (1'b0)),{(_zz_457_ != (1'b0)),{(_zz_458_ != _zz_459_),{_zz_460_,{_zz_461_,_zz_462_}}}}}};
  assign _zz_91_ = _zz_84_[8 : 7];
  assign _zz_45_ = _zz_91_;
  assign _zz_92_ = _zz_84_[12 : 11];
  assign _zz_44_ = _zz_92_;
  assign _zz_93_ = _zz_84_[14 : 13];
  assign _zz_43_ = _zz_93_;
  assign _zz_94_ = _zz_84_[17 : 16];
  assign _zz_42_ = _zz_94_;
  assign _zz_95_ = _zz_84_[19 : 18];
  assign _zz_41_ = _zz_95_;
  assign _zz_96_ = _zz_84_[25 : 24];
  assign _zz_40_ = _zz_96_;
  assign _zz_97_ = _zz_84_[34 : 33];
  ...
  always @ (*) begin
    case(execute_BRANCH_CTRL)
      ...
      default : begin
        execute_BranchPlugin_branch_src2 = ((execute_BRANCH_CTRL == `BranchCtrlEnum_defaultEncoding_JAL) ? {{_zz_148_,{{{_zz_632_,execute_INSTRUCTION[19 : 12]},execute_INSTRUCTION[20]},execute_INSTRUCTION[30 : 21]}},1'b0} : {{_zz_150_,{{{_zz_633_,_zz_634_},execute_INSTRUCTION[30 : 25]},execute_INSTRUCTION[11 : 8]}},1'b0});
...
module Apb3SpiXdrMasterCtrl (
  ...
  StreamFifo_4_ mapping_cmdLogic_streamUnbuffered_queueWithAvailability ( 
  ...
  StreamFifo_5_ ctrl_io_rsp_queueWithOccupancy ( 
...
module Apb3SpiXdrMasterCtrl_2_ (
  ...
  StreamFifo_8_ mapping_cmdLogic_streamUnbuffered_queueWithAvailability ( 
    .io_push_valid(mapping_cmdLogic_streamUnbuffered_valid),
    .io_push_ready(mapping_cmdLogic_streamUnbuffered_queueWithAvailability_io_push_ready),
    .io_push_payload_kind(mapping_cmdLogic_streamUnbuffered_payload_kind),
    .io_push_payload_read(mapping_cmdLogic_streamUnbuffered_payload_read),
  ...
  StreamFifo_9_ ctrl_io_rsp_queueWithOccupancy ( 
    .io_push_valid(ctrl_io_rsp_valid),
    .io_push_ready(ctrl_io_rsp_queueWithOccupancy_io_push_ready),
    .io_push_payload_data(ctrl_io_rsp_payload_data),
    .io_pop_valid(ctrl_io_rsp_queueWithOccupancy_io_pop_valid),
...
module BmbOnChipRam (
  ...
  reg [7:0] _zz_9_;
  initial begin
    $readmemb("Ulx3sLinuxXip85.v_toplevel_system_ramA_ram_symbol0.bin",ram_symbol0);
    $readmemb("Ulx3sLinuxXip85.v_toplevel_system_ramA_ram_symbol1.bin",ram_symbol1);
    $readmemb("Ulx3sLinuxXip85.v_toplevel_system_ramA_ram_symbol2.bin",ram_symbol2);
    $readmemb("Ulx3sLinuxXip85.v_toplevel_system_ramA_ram_symbol3.bin",ram_symbol3);
  end
  always @ (*) begin
...
module BmbSdramCtrl (
      ...
      input  [25:0] io_bmb_cmd_payload_fragment_address,
...
module BmbArbiter_2_ (
      ...
      input  [0:0] io_inputs_0_cmd_payload_fragment_source,
      input  [0:0] io_inputs_0_cmd_payload_fragment_opcode,
      input  [25:0] io_inputs_0_cmd_payload_fragment_address,
      input  [4:0] io_inputs_0_cmd_payload_fragment_length,
      input  [31:0] io_inputs_0_cmd_payload_fragment_data,
      input  [3:0] io_inputs_0_cmd_payload_fragment_mask,
      input  [0:0] io_inputs_0_cmd_payload_fragment_context,
      ...
      output [0:0] io_output_cmd_payload_fragment_source,
      output [0:0] io_output_cmd_payload_fragment_opcode,
      output [25:0] io_output_cmd_payload_fragment_address,
      output [4:0] io_output_cmd_payload_fragment_length,
      output [31:0] io_output_cmd_payload_fragment_data,
      output [3:0] io_output_cmd_payload_fragment_mask,
      output [0:0] io_output_cmd_payload_fragment_context,
...
module BmbDownSizerBridge (
      ...
      input  [0:0] io_input_cmd_payload_fragment_source,
      input  [0:0] io_input_cmd_payload_fragment_opcode,
      input  [25:0] io_input_cmd_payload_fragment_address,
      input  [4:0] io_input_cmd_payload_fragment_length,
      input  [31:0] io_input_cmd_payload_fragment_data,
      input  [3:0] io_input_cmd_payload_fragment_mask,
      input  [0:0] io_input_cmd_payload_fragment_context,
  ...
  assign _zz_5_ = {21'd0, io_input_cmd_payload_fragment_length};
  always @(*) begin
...
module BmbUnburstify_1_ (
      ...
      output  io_output_cmd_payload_last,
      output reg [0:0] io_output_cmd_payload_fragment_opcode,
      output reg [25:0] io_output_cmd_payload_fragment_address,
  ...
  reg  buffer_valid;
  reg [0:0] buffer_opcode;
  reg [25:0] buffer_address;
  reg [2:0] buffer_context;
  reg [3:0] buffer_beat;
  wire  buffer_last;
  wire [25:0] buffer_addressIncr;
  wire  buffer_isWrite;
  ...
  assign buffer_addressIncr = {buffer_address[25 : 12],(_zz_2_ & (~ (12'b000000000001)))};
  assign buffer_isWrite = (buffer_opcode == (1'b1));
...
module BmbDecoder_2_ (
  ...
  assign logic_hits_0 = ((io_input_cmd_payload_fragment_address & (~ (32'b00000011111111111111111111111111))) == (32'b10000000000000000000000000000000));
  always @ (*) begin
...
module Apb3Decoder (
  ...
  wire  _zz_1_;
  assign _zz_1_ = (io_input_PSEL[0] && (io_output_PSEL == (8'b00000000)));
  ...
  always @ (*) begin
    ...
    io_output_PSEL[7] = (((io_input_PADDR & (~ (24'b000000000000000000001111))) == (24'b000000010001000000000000)) && io_input_PSEL[0]);
  end
...
module Apb3Router (
  ...
  always @(*) begin
    case(selIndex)
      3'b000 : begin
        _zz_8_ = io_outputs_0_PREADY;
        _zz_9_ = io_outputs_0_PRDATA;
        _zz_10_ = io_outputs_0_PSLVERROR;
      end
      3'b001 : begin
        _zz_8_ = io_outputs_1_PREADY;
        _zz_9_ = io_outputs_1_PRDATA;
        _zz_10_ = io_outputs_1_PSLVERROR;
      end
      3'b010 : begin
        _zz_8_ = io_outputs_2_PREADY;
        _zz_9_ = io_outputs_2_PRDATA;
        _zz_10_ = io_outputs_2_PSLVERROR;
      end
      3'b011 : begin
        _zz_8_ = io_outputs_3_PREADY;
        _zz_9_ = io_outputs_3_PRDATA;
        _zz_10_ = io_outputs_3_PSLVERROR;
      end
      3'b100 : begin
        _zz_8_ = io_outputs_4_PREADY;
        _zz_9_ = io_outputs_4_PRDATA;
        _zz_10_ = io_outputs_4_PSLVERROR;
      end
      3'b101 : begin
        _zz_8_ = io_outputs_5_PREADY;
        _zz_9_ = io_outputs_5_PRDATA;
        _zz_10_ = io_outputs_5_PSLVERROR;
      end
      3'b110 : begin
        _zz_8_ = io_outputs_6_PREADY;
        _zz_9_ = io_outputs_6_PRDATA;
        _zz_10_ = io_outputs_6_PSLVERROR;
      end
      default : begin
        _zz_8_ = io_outputs_7_PREADY;
        _zz_9_ = io_outputs_7_PRDATA;
        _zz_10_ = io_outputs_7_PSLVERROR;
      end
    endcase
  end
  ...
  assign _zz_5_ = (((io_input_PSEL[1] || _zz_1_) || _zz_2_) || _zz_4_);
  assign _zz_6_ = (((io_input_PSEL[2] || _zz_1_) || _zz_3_) || _zz_4_);
  assign _zz_7_ = (((io_input_PSEL[4] || _zz_2_) || _zz_3_) || _zz_4_);
  assign io_input_PREADY = _zz_8_;
  assign io_input_PRDATA = _zz_9_;
  assign io_input_PSLVERROR = _zz_10_;
  always @ (posedge clkout1) begin
    selIndex <= {_zz_7_,{_zz_6_,_zz_5_}};
  end
...
module Ulx3sLinuxXip85 (
      ...
      output  system_uartB_uart_txd,
      input   system_uartB_uart_rxd,
  ...
  wire  system_uartB_io_apb_PREADY;
  wire [31:0] system_uartB_io_apb_PRDATA;
  wire  system_uartB_io_uart_txd;
  wire  system_uartB_io_interrupt;
  ...
  wire [25:0] system_sdramA_bmb_arbiter_io_output_cmd_payload_fragment_address;
  ...
  wire [25:0] system_sdramA_bmb_downSizer_io_output_cmd_payload_fragment_address;
  ...
  wire [25:0] system_sdramA_bmb_burstUnburstifier_io_output_cmd_payload_fragment_address;
  ...
  wire [7:0] generator_decoder_io_output_PSEL;
  ...
  wire [23:0] apb3Router_1__io_outputs_7_PADDR;
  ...
  wire  system_plic_targets_0_gateways_5_source;
  wire  generator;
  wire  generator_1_;
  wire  generator_2_;
  wire  generator_3_;
  ...
  wire [1:0] system_plic_targets_0_gateways_5_priority;
  reg  system_plic_targets_0_gateways_5_ip;
  reg  system_plic_targets_0_gateways_5_waitCompletion;
  ...
  wire  system_plic_targets_0_ie_5;
  ...
  wire [1:0] system_plic_targets_0_requests_6_priority;
  wire [2:0] system_plic_targets_0_requests_6_id;
  wire  system_plic_targets_0_requests_6_valid;
  wire  _zz_61_;
  wire [1:0] _zz_62_;
  wire  _zz_63_;
  wire  _zz_64_;
  ...
  wire  system_plic_targets_1_ie_5;
  ...
  wire [1:0] system_plic_targets_1_requests_6_priority;
  wire [2:0] system_plic_targets_1_requests_6_id;
  wire  system_plic_targets_1_requests_6_valid;
  wire  _zz_77_;
  wire [1:0] _zz_78_;
  wire  _zz_79_;
  wire  _zz_80_;
  ...
  assign _zz_150_ = (clockCtrl_holdingLogic_resetCounter != (10'b1111111111));
  assign _zz_151_ = (system_bridge_cmd_ready && (! system_bridge_cmd_s2mPipe_ready));
  assign _zz_152_ = ({2'd0,system_cpu_cpu_dBus_cmd_payload_length} <<< 2);
  assign _zz_153_ = system_plic_apb_PWDATA[1 : 1];
  assign _zz_154_ = system_plic_apb_PWDATA[2 : 2];
  assign _zz_155_ = system_plic_apb_PWDATA[4 : 4];
  assign _zz_156_ = system_plic_apb_PWDATA[5 : 5];
  assign _zz_157_ = system_plic_apb_PWDATA[6 : 6];
  assign _zz_158_ = system_plic_apb_PWDATA[7 : 7];
  assign _zz_159_ = system_plic_apb_PWDATA[1 : 1];
  assign _zz_160_ = system_plic_apb_PWDATA[2 : 2];
  assign _zz_161_ = system_plic_apb_PWDATA[4 : 4];
  assign _zz_162_ = system_plic_apb_PWDATA[5 : 5];
  assign _zz_163_ = system_plic_apb_PWDATA[6 : 6];
  assign _zz_164_ = system_plic_apb_PWDATA[7 : 7];
  pll_linux pll ( 
    .clkin(clk_25mhz),
    .clkout0(pll_clkout0),
    .clkout1(pll_clkout1),
  ...
  BufferCC_5_ bufferCC_7_ ( 
    .io_dataIn(clockCtrl_resetRequest),
    .io_dataOut(bufferCC_7__io_dataOut),
    .clkout1(pll_clkout1) 
  );
  MachineTimer system_machineTimer ( 
    .io_bus_PADDR(_zz_118_),
  ...
  Apb3UartCtrl system_uartB ( 
    .io_apb_PADDR(_zz_121_),
    .io_apb_PSEL(apb3Router_1__io_outputs_7_PSEL),
    .io_apb_PENABLE(apb3Router_1__io_outputs_7_PENABLE),
    .io_apb_PREADY(system_uartB_io_apb_PREADY),
    .io_apb_PWRITE(apb3Router_1__io_outputs_7_PWRITE),
    .io_apb_PWDATA(apb3Router_1__io_outputs_7_PWDATA),
    .io_apb_PRDATA(system_uartB_io_apb_PRDATA),
    .io_uart_txd(system_uartB_io_uart_txd),
    .io_uart_rxd(system_uartB_uart_rxd),
    .io_interrupt(system_uartB_io_interrupt),
    .clkout1(pll_clkout1),
    .clockCtrl_systemResetBeforeBuffer(clockCtrl_systemResetBeforeBuffer) 
  );
  VexRiscv system_cpu_cpu ( 
    ...
    .debug_bus_cmd_payload_address(_zz_123_),
    ...
    .iBus_rsp_payload_error(_zz_124_),
  ...
  BmbDecoder system_cpu_iBus_decoder ( 
    ...
    .io_input_cmd_payload_last(_zz_127_),
    .io_input_cmd_payload_fragment_opcode(_zz_128_),
    .io_input_cmd_payload_fragment_address(system_cpu_cpu_iBus_cmd_payload_address),
    .io_input_cmd_payload_fragment_length(_zz_129_),
    .io_input_rsp_valid(system_cpu_iBus_decoder_io_input_rsp_valid),
    .io_input_rsp_ready(_zz_130_),
  ...
  BmbDecoder_1_ system_cpu_dBus_decoder ( 
    ...
    .io_input_cmd_payload_fragment_opcode(_zz_131_),
    .io_input_cmd_payload_fragment_address(system_cpu_cpu_dBus_cmd_payload_address),
    .io_input_cmd_payload_fragment_length(_zz_132_),
  ...
  BmbArbiter system_bridge_bmb_arbiter ( 
    ...
    .io_inputs_1_cmd_payload_fragment_data(_zz_137_),
    .io_inputs_1_cmd_payload_fragment_mask(_zz_138_),
    .io_inputs_1_cmd_payload_fragment_context(_zz_139_),
  ...
  BmbArbiter_1_ system_ramA_bmb_arbiter ( 
    ...
    .io_inputs_0_cmd_payload_fragment_address(_zz_141_),
  ...
  BmbArbiter_2_ system_sdramA_bmb_arbiter ( 
    ...
    .io_inputs_0_cmd_payload_fragment_address(_zz_142_),
  ...
  BmbArbiter_3_ system_spiC_bmb_arbiter ( 
    ...
    .io_inputs_0_cmd_payload_fragment_address(_zz_143_),
  ...
  Apb3Router apb3Router_1_ ( 
    ...
    .io_outputs_2_PSLVERROR(_zz_144_),
    ...
    .io_outputs_4_PSLVERROR(_zz_145_),
    ...
    .io_outputs_5_PSLVERROR(_zz_146_),
    ...
    .io_outputs_6_PSLVERROR(_zz_147_),
    ...
    .io_outputs_7_PREADY(system_uartB_io_apb_PREADY),
    .io_outputs_7_PWRITE(apb3Router_1__io_outputs_7_PWRITE),
    .io_outputs_7_PWDATA(apb3Router_1__io_outputs_7_PWDATA),
    .io_outputs_7_PRDATA(system_uartB_io_apb_PRDATA),
    .io_outputs_7_PSLVERROR(_zz_148_),
    .clkout1(pll_clkout1),
    .clockCtrl_systemResetBeforeBuffer(clockCtrl_systemResetBeforeBuffer) 
  );
  ...
  BmbArbiter_4_ system_peripheralBridge_input_arbiter ( 
    ...
    .io_inputs_0_cmd_payload_fragment_address(_zz_149_),
  ...
  assign system_sdramA_sdram_DQ = _zz_1_ ? _zz_114_ : 16'bzzzzzzzzzzzzzzzz;
  always @ (*) begin
    _zz_1_ = 1'b0;
    if(_zz_115_)begin
      _zz_1_ = 1'b1;
  ...
  assign _zz_117_ = 1'b0;
  assign _zz_116_ = 1'b1;
  assign clockCtrl_inputResetTrigger = bufferCC_6__io_dataOut;
  always @ (*) begin
  ...
  assign system_uartB_uart_txd = system_uartB_io_uart_txd;
  assign _zz_124_ = (system_cpu_iBus_decoder_io_input_rsp_payload_fragment_opcode == (1'b1));
  assign _zz_35_[0] = system_cpu_cpu_dBus_cmd_payload_wr;
  assign _zz_125_ = (system_cpu_dBus_decoder_io_input_rsp_valid && (! system_cpu_dBus_decoder_io_input_rsp_payload_fragment_context[0]));
  assign _zz_126_ = (system_cpu_dBus_decoder_io_input_rsp_payload_fragment_opcode == (1'b1));
  assign _zz_123_ = systemDebugger_1__io_mem_cmd_payload_address[7:0];
  assign system_cpu_tdo = jtagBridge_1__io_jtag_tdo;
  assign _zz_130_ = 1'b1;
  assign _zz_127_ = 1'b1;
  assign _zz_128_ = (1'b0);
  assign _zz_129_ = (5'b11111);
  assign _zz_133_ = 1'b1;
  assign _zz_131_ = (system_cpu_cpu_dBus_cmd_payload_wr ? (1'b1) : (1'b0));
  assign _zz_132_ = (_zz_152_ | (5'b00011));
  ...
  assign _zz_137_ = (32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx);
  assign _zz_138_ = (4'bxxxx);
  assign _zz_139_ = (1'b0);
  assign _zz_140_ = 1'b0;
  assign system_plic_targets_0_gateways_2_source = system_gpioA_io_interrupt[0];
  assign system_plic_targets_0_gateways_3_source = system_gpioA_io_interrupt[1];
  assign system_plic_targets_0_gateways_4_source = system_gpioA_io_interrupt[2];
  assign system_plic_targets_0_gateways_5_source = system_gpioA_io_interrupt[3];
  ...
  always @ (*) begin
    ...
    case(system_plic_apb_PADDR)
      ...
      22'b0000000001000000001000 : begin
      ...
      22'b0000000000000000011100 : begin
        system_plic_apb_PRDATA[1 : 0] = system_plic_targets_0_gateways_5_priority;
      end
      22'b0000000001000000011100 : begin
        system_plic_apb_PRDATA[0 : 0] = system_plic_targets_0_gateways_5_ip;
      end
      ...
      22'b0000000010000000000000 : begin
        ...
        system_plic_apb_PRDATA[2 : 2] = system_plic_targets_0_ie_1;
        system_plic_apb_PRDATA[4 : 4] = system_plic_targets_0_ie_2;
        system_plic_apb_PRDATA[5 : 5] = system_plic_targets_0_ie_3;
        system_plic_apb_PRDATA[6 : 6] = system_plic_targets_0_ie_4;
        system_plic_apb_PRDATA[7 : 7] = system_plic_targets_0_ie_5;
      end
      ...
      22'b0000000010000010000000 : begin
        ...
        system_plic_apb_PRDATA[2 : 2] = system_plic_targets_1_ie_1;
        system_plic_apb_PRDATA[4 : 4] = system_plic_targets_1_ie_2;
        system_plic_apb_PRDATA[5 : 5] = system_plic_targets_1_ie_3;
        system_plic_apb_PRDATA[6 : 6] = system_plic_targets_1_ie_4;
        system_plic_apb_PRDATA[7 : 7] = system_plic_targets_1_ie_5;
      end
      default : begin
      end
    endcase
  ...
  assign system_plic_targets_0_requests_2_id = (3'b010);
  ...
  assign system_plic_targets_0_requests_3_id = (3'b100);
  ...
  assign system_plic_targets_0_requests_4_id = (3'b101);
  ...
  assign system_plic_targets_0_requests_5_id = (3'b110);
  assign system_plic_targets_0_requests_5_valid = (system_plic_targets_0_gateways_4_ip && system_plic_targets_0_ie_4);
  assign system_plic_targets_0_requests_6_priority = system_plic_targets_0_gateways_5_priority;
  assign system_plic_targets_0_requests_6_id = (3'b111);
  assign system_plic_targets_0_requests_6_valid = (system_plic_targets_0_gateways_5_ip && system_plic_targets_0_ie_5);
  ...
  assign _zz_73_ = ((! system_plic_targets_0_requests_6_valid) || (_zz_69_ && (system_plic_targets_0_requests_6_priority <= _zz_68_)));
  assign _zz_74_ = (_zz_73_ ? _zz_68_ : system_plic_targets_0_requests_6_priority);
  assign _zz_75_ = (_zz_73_ ? _zz_69_ : system_plic_targets_0_requests_6_valid);
  assign _zz_76_ = ((! _zz_75_) || (_zz_72_ && (_zz_74_ <= _zz_71_)));
  assign system_plic_targets_0_bestRequest_priority = (_zz_76_ ? _zz_71_ : _zz_74_);
  assign system_plic_targets_0_bestRequest_id = (_zz_76_ ? (_zz_70_ ? (_zz_61_ ? system_plic_targets_0_requests_0_id : system_plic_targets_0_requests_1_id) : (_zz_64_ ? system_plic_targets_0_requests_2_id : system_plic_targets_0_requests_3_id)) : (_zz_73_ ? (_zz_67_ ? system_plic_targets_0_requests_4_id : system_plic_targets_0_requests_5_id) : system_plic_targets_0_requests_6_id));
  assign system_plic_targets_0_bestRequest_valid = (_zz_76_ ? _zz_72_ : _zz_75_);
  ...
  assign system_plic_targets_1_requests_2_id = (3'b010);
  ...
  assign system_plic_targets_1_requests_3_id = (3'b100);
  ...
  assign system_plic_targets_1_requests_4_id = (3'b101);
  ...
  assign system_plic_targets_1_requests_5_id = (3'b110);
  assign system_plic_targets_1_requests_5_valid = (system_plic_targets_0_gateways_4_ip && system_plic_targets_1_ie_4);
  assign system_plic_targets_1_requests_6_priority = system_plic_targets_0_gateways_5_priority;
  assign system_plic_targets_1_requests_6_id = (3'b111);
  assign system_plic_targets_1_requests_6_valid = (system_plic_targets_0_gateways_5_ip && system_plic_targets_1_ie_5);
  assign _zz_77_ = ((! system_plic_targets_1_requests_1_valid) || (system_plic_targets_1_requests_0_valid && (system_plic_targets_1_requests_1_priority <= system_plic_targets_1_requests_0_priority)));
  assign _zz_78_ = (_zz_77_ ? system_plic_targets_1_requests_0_priority : system_plic_targets_1_requests_1_priority);
  assign _zz_79_ = (_zz_77_ ? system_plic_targets_1_requests_0_valid : system_plic_targets_1_requests_1_valid);
  assign _zz_80_ = ((! system_plic_targets_1_requests_3_valid) || (system_plic_targets_1_requests_2_valid && (system_plic_targets_1_requests_3_priority <= system_plic_targets_1_requests_2_priority)));
  assign _zz_81_ = (_zz_80_ ? system_plic_targets_1_requests_2_priority : system_plic_targets_1_requests_3_priority);
  assign _zz_82_ = (_zz_80_ ? system_plic_targets_1_requests_2_valid : system_plic_targets_1_requests_3_valid);
  assign _zz_83_ = ((! system_plic_targets_1_requests_5_valid) || (system_plic_targets_1_requests_4_valid && (system_plic_targets_1_requests_5_priority <= system_plic_targets_1_requests_4_priority)));
  assign _zz_84_ = (_zz_83_ ? system_plic_targets_1_requests_4_priority : system_plic_targets_1_requests_5_priority);
  assign _zz_85_ = (_zz_83_ ? system_plic_targets_1_requests_4_valid : system_plic_targets_1_requests_5_valid);
  assign _zz_86_ = ((! _zz_82_) || (_zz_79_ && (_zz_81_ <= _zz_78_)));
  assign _zz_87_ = (_zz_86_ ? _zz_78_ : _zz_81_);
  assign _zz_88_ = (_zz_86_ ? _zz_79_ : _zz_82_);
  assign _zz_89_ = ((! system_plic_targets_1_requests_6_valid) || (_zz_85_ && (system_plic_targets_1_requests_6_priority <= _zz_84_)));
  assign _zz_90_ = (_zz_89_ ? _zz_84_ : system_plic_targets_1_requests_6_priority);
  assign _zz_91_ = (_zz_89_ ? _zz_85_ : system_plic_targets_1_requests_6_valid);
  assign _zz_92_ = ((! _zz_91_) || (_zz_88_ && (_zz_90_ <= _zz_87_)));
  assign system_plic_targets_1_bestRequest_priority = (_zz_92_ ? _zz_87_ : _zz_90_);
  assign system_plic_targets_1_bestRequest_id = (_zz_92_ ? (_zz_86_ ? (_zz_77_ ? system_plic_targets_1_requests_0_id : system_plic_targets_1_requests_1_id) : (_zz_80_ ? system_plic_targets_1_requests_2_id : system_plic_targets_1_requests_3_id)) : (_zz_89_ ? (_zz_83_ ? system_plic_targets_1_requests_4_id : system_plic_targets_1_requests_5_id) : system_plic_targets_1_requests_6_id));
  assign system_plic_targets_1_bestRequest_valid = (_zz_92_ ? _zz_88_ : _zz_91_);
  ...
  assign system_plic_targets_0_gateways_0_priority = _zz_93_;
  assign system_plic_targets_0_gateways_1_priority = _zz_94_;
  assign system_plic_targets_0_gateways_2_priority = _zz_95_;
  assign system_plic_targets_0_gateways_3_priority = _zz_96_;
  assign system_plic_targets_0_gateways_4_priority = _zz_97_;
  assign system_plic_targets_0_gateways_5_priority = _zz_98_;
  always @ (*) begin
  ...
  assign system_plic_targets_0_threshold = _zz_99_;
  always @ (*) begin
  ...
  assign system_plic_targets_0_ie_0 = _zz_100_;
  assign system_plic_targets_0_ie_1 = _zz_101_;
  assign system_plic_targets_0_ie_2 = _zz_102_;
  assign system_plic_targets_0_ie_3 = _zz_103_;
  assign system_plic_targets_0_ie_4 = _zz_104_;
  assign system_plic_targets_0_ie_5 = _zz_105_;
  assign system_plic_targets_1_threshold = _zz_106_;
  always @ (*) begin
  ...
  assign system_plic_targets_1_ie_0 = _zz_107_;
  assign system_plic_targets_1_ie_1 = _zz_108_;
  assign system_plic_targets_1_ie_2 = _zz_109_;
  assign system_plic_targets_1_ie_3 = _zz_110_;
  assign system_plic_targets_1_ie_4 = _zz_111_;
  assign system_plic_targets_1_ie_5 = _zz_112_;
  assign system_sdramA_sdram_ADDR = system_sdramA_io_sdram_ADDR;
  assign system_sdramA_sdram_BA = system_sdramA_io_sdram_BA;
  assign _zz_114_ = system_sdramA_io_sdram_DQ_write;
  assign _zz_115_ = system_sdramA_io_sdram_DQ_writeEnable;
  ...
  assign _zz_142_ = system_bridge_bmb_decoder_io_outputs_0_cmd_payload_fragment_address[25:0];
  assign _zz_141_ = system_bridge_bmb_decoder_io_outputs_1_cmd_payload_fragment_address[12:0];
  ...
  assign _zz_118_ = apb3Router_1__io_outputs_1_PADDR[3:0];
  assign _zz_119_ = apb3Router_1__io_outputs_2_PADDR[3:0];
  assign _zz_144_ = 1'b0;
  assign _zz_120_ = apb3Router_1__io_outputs_3_PADDR[11:0];
  assign _zz_134_ = apb3Router_1__io_outputs_4_PADDR[7:0];
  assign _zz_145_ = 1'b0;
  assign _zz_135_ = apb3Router_1__io_outputs_5_PADDR[7:0];
  assign _zz_146_ = 1'b0;
  assign _zz_136_ = apb3Router_1__io_outputs_6_PADDR[7:0];
  assign _zz_147_ = 1'b0;
  assign _zz_121_ = apb3Router_1__io_outputs_7_PADDR[3:0];
  ...
  assign _zz_149_ = system_bridge_bmb_decoder_io_outputs_2_cmd_payload_fragment_address[23:0];
  assign _zz_143_ = system_bridge_bmb_decoder_io_outputs_3_cmd_payload_fragment_address[23:0];
  ...
  assign _zz_113_ = system_sdramA_sdram_DQ;
  assign _zz_122_ = 1'b0;
  ...
  always @ (posedge pll_clkout1) begin
    clockCtrl_systemResetBeforeBuffer <= (clockCtrl_resetUnbuffered || bufferCC_7__io_dataOut);
  ...
  always @ (posedge pll_clkout1) begin
    if(clockCtrl_systemResetBeforeBuffer) begin
      ...
      system_plic_targets_0_gateways_5_ip <= 1'b0;
      system_plic_targets_0_gateways_5_waitCompletion <= 1'b0;
      _zz_93_ <= (2'b00);
      _zz_94_ <= (2'b00);
      _zz_95_ <= (2'b00);
      _zz_96_ <= (2'b00);
      ...
      if((! system_plic_targets_0_gateways_1_waitCompletion))begin
        system_plic_targets_0_gateways_1_ip <= system_uartB_io_interrupt;
        system_plic_targets_0_gateways_1_waitCompletion <= system_uartB_io_interrupt;
      end
      ...
      if((! system_plic_targets_0_gateways_5_waitCompletion))begin
        system_plic_targets_0_gateways_5_ip <= system_plic_targets_0_gateways_5_source;
        system_plic_targets_0_gateways_5_waitCompletion <= system_plic_targets_0_gateways_5_source;
      end
      ...
      case(system_plic_apb_PADDR)
        22'b0000000000000000000100 : begin
          if(system_plic_bus_doWrite)begin
            _zz_93_ <= system_plic_apb_PWDATA[1 : 0];
          end
        end
        22'b0000000001000000000100 : begin
        end
        22'b0000000000000000001000 : begin
          if(system_plic_bus_doWrite)begin
            _zz_94_ <= system_plic_apb_PWDATA[1 : 0];
          end
        end
        22'b0000000001000000001000 : begin
        end
        22'b0000000000000000010000 : begin
          if(system_plic_bus_doWrite)begin
            _zz_95_ <= system_plic_apb_PWDATA[1 : 0];
          end
        end
        22'b0000000001000000010000 : begin
        end
        22'b0000000000000000010100 : begin
          if(system_plic_bus_doWrite)begin
            _zz_96_ <= system_plic_apb_PWDATA[1 : 0];
          end
        end
        22'b0000000001000000010100 : begin
        end
        22'b0000000000000000011000 : begin
          if(system_plic_bus_doWrite)begin
            _zz_97_ <= system_plic_apb_PWDATA[1 : 0];
          end
        end
        22'b0000000001000000011000 : begin
        end
        ...
        22'b1000000000000000000000 : begin
          if(system_plic_bus_doWrite)begin
            _zz_99_ <= system_plic_apb_PWDATA[1 : 0];
          end
        end
        22'b1000000000000000000100 : begin
        end
        ...
        22'b1000000001000000000000 : begin
          if(system_plic_bus_doWrite)begin
            _zz_106_ <= system_plic_apb_PWDATA[1 : 0];
          end
        end
        22'b1000000001000000000100 : begin
        end
